...
BEGIN_MESSAGE_MAP(CAboutDlg, CDialogEx)
	ON_NOTIFY(NM_CLICK, IDC_LIST1, &CAboutDlg::OnNMClickList1)
END_MESSAGE_MAP()
...
BEGIN_MESSAGE_MAP(CmfcdemoDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_COMMAND(IDC_STATIC, &CmfcdemoDlg::OnStatic)
END_MESSAGE_MAP()
...
void CAboutDlg::OnNMClickList1(NMHDR* pNMHDR, LRESULT* pResult)
{
